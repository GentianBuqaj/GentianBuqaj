...
# Current project: ft_transcendence
A REST API Web Application centered on a multiplayer game.  
**Collaborators:** @Ldelahay, @sidneybaumann

### Core Responsibilities

**Backend & Server Architecture**
Basic user management system with a database.
* **Stack:** TypeScript, Fastify, PostgreSQL, Prisma, Zod.
* **Security:** Argon2, JWT, Cookie management, CSRF protection.
* **Documentation:** Swagger/OpenAPI.

**DevOps & Infrastructure**
* **Containerization:** Docker for streamlined development and production deployment.
* **Observability:** Implementation of monitoring dashboards via Prometheus and Grafana.

**Game Development**
* **Engine:** With TypeScript and HTML5 Canvas. Mechanics inspired by curvefever.com. 
* **Frontend:** Built the menu and configuration interface using React.
...
~~**Pragmatic Curiosity:** I dig "under the hood" to understand the core logic, but I stay focused on delivery. I need to know how the engine works—not the atomic composition of the pistons.~~  
~~* **Balanced Optimization:** Performance is a priority, but never at the expense of code clarity or project timelines. Over-engineering is just another form of technical debt.~~  
...
~~* **Resilient:** Calm under pressure and technically "unbreakable." High-stress environments and complex failures don't phase me; they just provide more data.~~
